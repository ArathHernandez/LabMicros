...
Total:
    movwf Resultado,A ; mueve el valor a Resultado
    call Resta_nueva
    btfsc Resultado,7,A
    goto print_final
    movff Resultado, Aux_result
    call Dividir_10
    movff Aux_result, Resultado
    movff Decenas, Aux_result
    movff Resultado, Unidades
    call Resta_unidades
    rrncf Decenas,1,0
    rrncf Decenas,1,0
    rrncf Decenas,1,0
    ...
    movf Decenas,W,A
    XORWF Unidades, 1
    movff Unidades,LATD ; mueve el valor a LATD
    return ; devuelve el control al llamador
...
Resta_unidades:
    ...
    btfsc Aux_result,3,A
    goto Resta_unidades
    btfsc Aux_result,2,A
    goto Resta_unidades
    btfsc Aux_result,1,A
    goto Resta_unidades
    btfsc Aux_result,0,A
    goto Resta_unidades
    return
